...
class Stats:
    ...
    def sort_stats(self, *field):
        ...
        if len(field) == 1 and isinstance(field[0], int):
            ...
            field = [
                {-1: "stdname", 0: "calls", 1: "time", 2: "cumulative"}[
                    field[0]
                ]
            ]
        elif len(field) >= 2:
    ...
    def get_stats_profile(self):
        ...
        """
        func_list = (
            self.fcn_list[:] if self.fcn_list else list(self.stats.keys())
        )
        if not func_list:
    ...
    def print_stats(self, *amount):
        ...
        if self.total_calls != self.prim_calls:
            print(
                "(%d primitive calls)" % self.prim_calls,
                end=' ',
                file=self.stream,
            )
    ...
    def print_call_heading(self, name_size, column_title):
        ...
        if subheader:
            print(
                " " * name_size + "    ncalls  tottime  cumtime",
                file=self.stream,
            )
...
if __name__ == '__main__':
    ...
    class ProfileBrowser(cmd.Cmd):
        ...
        def help_read(self):
            print(
                "Read in profile data from a specified file.", file=self.stream
            )
            print(
                "Without argument, reload the current file.", file=self.stream
            )
